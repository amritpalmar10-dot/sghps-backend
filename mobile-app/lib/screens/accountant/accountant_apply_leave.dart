...
class AccountantApplyLeave extends StatefulWidget {
  const AccountantApplyLeave({super.key});

  @override
  State<AccountantApplyLeave> createState() => _AccountantApplyLeaveState();
}

class _AccountantApplyLeaveState extends State<AccountantApplyLeave> {
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Tap to select date',
                              prefixIcon:
                                  const Icon(Icons.event, color: primaryPurple),
                              suffixIcon: const Icon(Icons.arrow_drop_down,
                                  color: primaryPurple),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: const Padding(
                                ...
                                child: Icon(Icons.notes, color: primaryPurple),
                              ),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
                              ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        fontSize: 11, color: primaryPurple),
                                  ),
                                ),
                              ],
                            ),
