      ...
      if (data['success']) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('✅ Leave request sent to Class Incharge!'),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text('Send to Class Incharge',
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 18,
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Tap to select date',
                              prefixIcon:
                                  const Icon(Icons.event, color: primaryBlue),
                              suffixIcon: const Icon(Icons.arrow_drop_down,
                                  color: primaryBlue),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: const Padding(
                                ...
                                child: Icon(Icons.notes, color: primaryBlue),
                              ),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(12),
                              ),
                          ...
                          Container(
                            ...
                            child: const Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    'Request will be sent to your Class Incharge Teacher.',
                                    style: TextStyle(
